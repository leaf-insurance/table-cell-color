...
export default class Table {
     ...
     */
    setCellColor(row: number, column: number, color: string): void;
    /**
     ...
     */
    setCellContent(row: number, column: number, content: string, styles?: {}): void;
    /**
     ...
     */
    cellClickListener(event: MouseEvent): void;
    /**
